...
public OnPluginStart()
{
    ...
    HookEvent("finale_vehicle_leaving", Event_FinaleVehicle, EventHookMode_PostNoCopy);
    HookEvent("player_death", Event_PlayerDeath);
    distance_reset_time = CreateConVar("distance_reset_time", "8", "How often should we reset distance points? Min 3, Max 60", FCVAR_PLUGIN, true, 3.0, true, 60.0);
}
...
public Action:Event_FinaleVehicle(Handle:event, const String:name[], bool:dontBroadcast)
{
    LiveDistance = false;
}
